...
export default function GenreListPage() {
  ...
  return (
    <div className="max-w-6xl py-6 bg-white border-2  container px-4 mx-auto shadow-sm">
      <h1 className="mb-10 text-3xl font-bold text-center uppercase">Genre List</h1>
